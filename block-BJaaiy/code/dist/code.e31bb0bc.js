...
},{}],"../../../../../.nvm/versions/node/v12.18.3/lib/node_modules/parcel-bundler/node_modules/base64-js/index.js":[function(require,module,exports) {
'use strict'
...
},{"buffer":"../../../../../.nvm/versions/node/v12.18.3/lib/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"index.js":[function(require,module,exports) {
...
var aDate = moment(dateElt.value, 'YYYY-MM-DD', true);
var isValid = aDate.isValid();
console.log(isValid); // Manipulating Dates

console.log(moment().add(7, 'days').calendar());
console.log(moment().add(7, 'months').calendar());
console.log(moment().add(7, 'years').calendar()); // - subtracts 7 days to current date
...
console.log(moment().subtract(7, 'years').calendar()); // Find the difference between the following 2 dates:
// 1.
// - date1: `2014-11-11`
// - date2: `2015-09-11`
...
var result = 'Diff: ' + date2.diff(date1, 'days') + " days";
console.log(result); // - Check is `2020-01-01` date after `2018-01-01`

console.log(moment('2020-01-01').isAfter('2018-01-01', 'year')); // - Check is `2010-01-01` date after `2018-01-01`

console.log(moment('2010-01-01').isAfter('2018-01-01', 'year')); // - Check if the year `2019` is a leap year

console.log(moment([2019]).isLeapYear()); // - Check if the year `2020` is a leap year

console.log(moment([2020]).isLeapYear()); // #### Use lodash to do the following things:
...
var compact = lodash.compact(numbers);
console.log(compact); //concat
...
console.log(lodash.difference([2, 1], [2, 3])); // => [1]
//drop

console.log(lodash.drop([1, 2, 3]));
console.log(lodash.drop([1, 2, 3], 2));
console.log(lodash.drop([1, 2, 3], 5)); //zipped
...
var count = lodash.countBy([6.1, 4.2, 6.3], Math.floor);
...
var active = lodash.filter(users, function (o) {
  return !o.active;
});
console.log(active); // => objects for ['fred']
// The `_.matches` iteratee shorthand.

var match = lodash.filter(users, {
  'age': 36,
  'active': true
});
console.log(match); // => objects for ['barney']
//find

console.log(lodash.filter(users, ['active', false])); // => objects for ['fred']
//forEach

var some = lodash.forEach([1, 2], function (value) {
  console.log(value);
});
console.log(some); //includes
...
console.log(lodash.map([4, 8], square)); //sampleSize

console.log(lodash.sampleSize([1, 2, 3], 2)); // => [3, 1]
},{"moment":"node_modules/moment/moment.js","lodash":"node_modules/lodash/lodash.js"}],"../../../../../.nvm/versions/node/v12.18.3/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../../.nvm/versions/node/v12.18.3/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
